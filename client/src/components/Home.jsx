    ...
    <>
      ...
      <div style={containerStyle}>
        ...
        <p style={paragraphStyle}>
          ...
          <p style={paragraphStyle}>
            ઉમેદવારીપત્રોની ચકાસણી માટેની તારીખ, ઉમેદવારીપત્રો ભરવાની છેલ્લી
            તારીખ પછીનો બીજો દિવસ રહેશે.
          </p>
          <p style={paragraphStyle}>
            ઉમેદવારીપત્રો પાછા ખેંચવાની તારીખ, ઉમેદવારીપત્રોની ચકાસણી માટેની
            તારીખ પછીનો દિવસ રહેશે.
          </p>
          <p style={paragraphStyle}>
            મતદાન/ચૂંટણીની તારીખ, ઉમેદવારી પાછી ખેંચી લેવાની તારીખનાં ૧૦(દસ)
            દિવસો કરતાં વહેલી હોવી જોઈશે નહીં.
          </p>
        </p>
        <p style={paragraphStyle}>
          સામાન્યતઃ મતગણતરી ચૂંટણી અધિકારી, મતદાનની તારીખ પહેલાં ઓછામાં ઓછા એક
          અઠવાડિયા અગાઉ મતગણતરી કરવાનું સ્થળ, તારીખ અને સમય નકકી કરશે.
        </p>
        <button
          // href=navigat("/result")
          style={buttonStyle}
